...
<div class="container-fluid p-0">
    <div class="col-md-12 border-top border-bottom mb-4">
        <h3 class="text-center mt-3 mb-3" style="color: black !important;">Player Ratings</h3>
    ...
    <div class="container-fluid p-0">
        <div class="col-md-12 border-top border-bottom mb-4">
            <h3 class="text-center mt-3 mb-3" style="color: black !important;">Pro Stats - Multiple Teams</h3>
            <table class="table table-bordered text-center">
                <thead class="table-dark">
                    <tr>
                        <th>Team</th>
...
<div class="container-fluid p-0">
        <!-- Pro Stats -->
    <div class="col-md-12 border-top border-bottom mb-4">
        <h3 class="text-center mt-3 mb-3" style="color: black !important;">Pro Stats</h3>
...
<div class="container-fluid p-0">
        <div class="col-md-12 border-top border-bottom mb-4">
            <h3 class="text-center mt-3 mb-3" style="color: black !important;">Farm Stats</h3>
...
<?php if ($PlayerFarmStatMultipleTeamFound == true): ?>
    <div class="container-fluid p-0">
        <div class="col-md-12 border-top border-bottom mb-4">
            <h3 class="text-center mt-3 mb-3" style="color: black !important;">Farm Stats - Multiple Teams</h3>
        <table class="table table-bordered text-center">
                <thead class="table-dark">
                    <tr>
                        <th>Team</th>
...
<?php if ($PlayerCareerStatFound == true): ?>
    <div class="container-fluid p-0">
        <div class="col-md-12 border-top border-bottom mb-4">
            <h3 class="text-center mt-3 mb-3" style="color: black !important;">Career Statistics</h3>
