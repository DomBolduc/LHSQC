...
<form id="Trade" name="Trade" method="post" action="TradeConfirm.php<?php If ($lang == "fr" ){echo "?Lang=fr";}?>">
	...
	if (empty($Team2Player) == false){
		...
		foreach ($Team2Player as $values){
			...
			If ($Confirm == True){
				...
				$Query = "INSERT INTO Trade (FromTeam,ToTeam,Player,ConfirmFrom,ConfirmTo) VALUES('" . $Team2 . "','" . $Team1 . "','" . $values . "','False','False')";
	...
	if (empty($Team2Prospect) == false){
		...
		foreach ($Team2Prospect as $values){
			...
			If ($Confirm == True){
				...
				$Query = "INSERT INTO Trade (FromTeam,ToTeam,Prospect,ConfirmFrom,ConfirmTo) VALUES('" . $Team2 . "','" . $Team1 . "','" . $values . "','False','False')";
	...
	if (empty($Team2DraftPick) == false){
		...
		foreach ($Team2DraftPick as $values){
			...
			If ($Confirm == True){
				...
				$Query = "INSERT INTO Trade (FromTeam,ToTeam,DraftPick,ConfirmFrom,ConfirmTo) VALUES('" . $Team2 . "','" . $Team1 . "','" . $values . "','False','False')";
		...
		foreach ($Team2DraftPickCon as $values){
			...
			If ($Boofound == False){
				...
				If ($Confirm == True){
					...
					$Query = "INSERT INTO Trade (FromTeam,ToTeam,DraftPick,ConfirmFrom,ConfirmTo) VALUES('" . $Team2 . "','" . $Team1 . "','" . ($values + 10000) . "','False','False')";
	...
	If ($Confirm == True){
		...
		$Query = "INSERT INTO Trade (FromTeam,ToTeam,Money,SalaryCapY1,SalaryCapY2,ConfirmFrom,ConfirmTo) VALUES('" . $Team2 . "','" . $Team1 . "','" . $Team2Money . "','" . $Team2SalaryCapY1. "','" . $Team2SalaryCapY2 . "','False','False')";
