    ...
    <table class="STHSPHPTeamHeader_Table">
        ...
        <tr>
            <td class="STHSPHPTeamHeader_Stat">
                ...
                <!-- Bouton Pro Team -->
                <a href="ProTeam.php?Team=<?php echo $Team; ?>" class="pro-team-btn" style="display: inline-block; margin-left: 15px; padding: 6px 12px; background: #007bff; color: white; text-decoration: none; border-radius: 4px; font-size: 12px; font-weight: bold; transition: background-color 0.3s;">
